...
Defines the versioned JSON API namespace (`/api/v1/*`) that the React frontend consumes. All endpoints wrap existing `db.py` query methods without introducing new schema or DDL changes.
