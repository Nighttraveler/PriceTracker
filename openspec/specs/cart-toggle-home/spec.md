# Spec: cart-toggle-home

## Purpose

Cart toggle buttons on the home page reflect and control each item's cart membership, allowing users to add or remove items directly from the home page without navigating away.
